...
public class WordsBean {
     ...
     * status_code : 0
     * msg : SUCCESS
     * data : {"en_definitions":{"n":["an expression of greeting"]},"cn_definition":{"pos":"",
     * "defn":"int.（见面打招呼或打电话用语）喂,哈罗"},"id":3130,"retention":4,"definition":" int.（见面打招呼或打电话用语）喂,
     * 哈罗","target_retention":5,"en_definition":{"pos":"n","defn":"an expression of greeting"},
     * "learning_id":2915819690,"content":"hello","pronunciation":"hә'lәu","audio":"http://media
     * .shanbay.com/audio/us/hello.mp3","uk_audio":"http://media.shanbay.com/audio/uk/hello.mp3",
